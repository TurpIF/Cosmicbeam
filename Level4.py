...
class Level4(Game.Game):
	def construct(self):
		...
		self.emitters = []
		self.emitters += [Emitter(self.sprEmitters[0].GetPosition()[0] + self.sprEmitters[0].GetSize()[0] - 5, self.sprEmitters[0].GetPosition()[1] + self.sprEmitters[0].GetSize()[1] / 2.0, 60, 40, sf.Color(255, 0, 0), 300)]
		self.emitters += [Emitter(self.sprEmitters[0].GetPosition()[0] + self.sprEmitters[0].GetSize()[0] - 5, self.sprEmitters[0].GetPosition()[1] + self.sprEmitters[0].GetSize()[1] / 2.0, 60, -40, sf.Color(0, 255, 0), 300)]
		...
		self.receptors = []
		self.receptors += [Receptor(self.sprReceptors[0], 400)]
		...
		self.engine.obstacles += [Mirror(200, 400, 800, 500, True)]
